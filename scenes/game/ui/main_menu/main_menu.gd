...
const PATH_LEVEL_1 = "res://scenes/game/levels/rooms/scene_3/scene_3.tscn"
...
func _toggle_show():
	...
	# Buscamos el nodo principal del nivel actual "Main" en la jerarquía
	var main_node = get_node("Main")  # Accedemos al nodo "Main" en la jerarquía local
	if main_node:
